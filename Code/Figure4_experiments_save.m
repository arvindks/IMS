%% This script saves data for the plot of "Figure4_experiments.m" to .csv format
%
...
%suffix = 'Figure4_experiments_05-26-02-46';
suffix = 'Figure4_experiments_5_08-26-11-38';
...
%% Load results AIC
prefix = '/Users/ecchi/Dropbox/Work/Research/00_Active/00_NCSU/01_BMC/results/';
suffix = 'numerical_ex5_AIC_08-28-09-25';
FileName = [prefix, suffix];
FileName_runtime = [FileName,'_runtime.mat'];
