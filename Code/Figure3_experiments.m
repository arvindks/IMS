...
result_bic = zeros(n_repeat, n_sz+1, n_miss_pct);
...
for miss_pct_idx = 1:n_miss_pct
    ...
    for repeat_idx = 1:n_repeat
        ...
        for hut_sz_idx =1:n_sz
            ...
            result_bic(repeat_idx, hut_sz_idx,miss_pct_idx) = bic_best;
            z = X_complete(:);
        ...
        result_bic(repeat_idx, n_sz+1,miss_pct_idx) = bic_best;
        z = X_complete(:);
...
%% Save results
FileName = ['S:\Documents\BMC\results\','Figure3_experiments_',...
